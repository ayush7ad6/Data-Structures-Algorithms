...
void DaddEdge(vector<int> adj[], int u, int v); //directed
void printAdj(vector<int> adj[], int v);
void BFS(vector<int> adj[], int v, int s);
void BFSrec(vector<int> adj[], int v);                                  //traversal without source
void BFS_(vector<int> adj[], int v, bool visited[]);                    //follow up for BFSrec()
...
void DFSrec(vector<int> adj[], int v, int s, bool visited[]);           //follow up function for ^
